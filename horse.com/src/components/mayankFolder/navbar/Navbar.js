  ...
  return (
    <navbar>
        <div className='navbar' style={{borderBottom:'1px solid #545540'}}>
                ...
                <ul>
                  ...
                  <div className='SubMenu_1'>
                    <div class='submenu_2'  >
                      ...
                      <div className='submenu_3' style={{border:'1px solid pink'}}>
                        <div className='subline' style={{marginLeft:'-240px', padding:'70px 0 0 0',marginRight:"90px"}}>
                        <Link to="/products/New" style={{textDecoration:'none',color:'#545540'}}><h3>New</h3>
                          <p>New Arrivals</p>
                          <p>Back In Stock</p>
                          <p>Coming Soon</p></Link>
                        </div>
                        <div className='hovimg0' style={{display:'grid', gridTemplateColumns:'repeat(2,1fr)' , gap:'40px' ,width:'40%',padding:'30px 0 0 0'}}>
                          <div className='hovimg' style={{display:'flex', flexDirection:'column'}}>
                            <img src='https://cdn.shopify.com/s/files/1/0233/5133/files/mega_52c9fc4b-2e6a-4492-bf5e-3c068318e022_600x.jpg?v=1667793990' alt='img' style={{width:'270px'}}/>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Bags" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <Link to="/products/Bags" style={{textDecoration:'none',color:'#545540'}}><h3>BY  BRAND</h3>
                        <p>111Skin</p>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Hair" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <Link to="/products/Hair" style={{textDecoration:'none',color:'#545540'}}><h3>BY  BRAND</h3>
                        <p>111Skin</p>
                        <p>Augustinus Bader</p>
                        <p>Balm Labs</p>
                        <p>Dr Barbara Sturm</p>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Bath&Body" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <Link to="/products/Bath&Body" style={{textDecoration:'none',color:'#545540'}}><h3>BY  BRAND</h3>
                        <p>111Skin</p>
                        <p>Augustinus Bader</p>
                        <p>Balm Labs</p>
                        <p>Dr Barbara Sturm</p>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Fragnance" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <Link to="/products/Fragnance" style={{textDecoration:'none',color:'#545540'}}><h3>BY  BRAND</h3>
                        <p>111Skin</p>
                        <p>Augustinus Bader</p>
                        <p>Balm Labs</p>
                        <p>Dr Barbara Sturm</p>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Tools&Accessories" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <Link to="/products/Tools&Accessories" style={{textDecoration:'none',color:'#545540'}}><h3>BY  BRAND</h3>
                        <p>111Skin</p>
                        <p>Augustinus Bader</p>
                        <p>Balm Labs</p>
                        <p>Dr Barbara Sturm</p>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Wellness" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <h3>BY  BRAND</h3>
                    <Link to="/products/Wellness" style={{textDecoration:'none',color:'#545540'}}><p>111Skin</p>
                        <p>Augustinus Bader</p>
                        <p>Balm Labs</p>
                        <p>Dr Barbara Sturm</p>
                        <p>EltaMD</p>
                        ...
                        <div className='submenu_3'>
                          <div>
                          <Link to="/products/Gifts" style={{textDecoration:'none',color:'#545540'}}><h3>BY CATEGORY</h3>
                        <p>Shop All</p>
                        <p>Skincare</p>
                        <p>Makeup</p>
                        <p>Hair</p>
                    ...
                    < div>
                    <h3>BY  BRAND</h3>
                    <Link to="/products/Gifts" style={{textDecoration:'none',color:'#545540'}}><p>111Skin</p>
                        <p>Augustinus Bader</p>
                        <p>Balm Labs</p>
                        <p>Dr Barbara Sturm</p>
                        <p>EltaMD</p>
            ...
            <div id='logo'><p>THE HORSE</p></div>
            <div style={{display:'flex',justifyContent:'space-evenly'}}>
              <div>AUD</div>
              <div style={{fontSize:'15px', letterSpacing:'0.05em'}}>My Account</div>
              <div><img src={heart} alt="img" style={{width:'18px'}}/></div>
              <div><button style={{border:'none',backgroundColor:'transparent'}}><img src={search} alt="img" style={{width:'18px'}}/></button></div>
